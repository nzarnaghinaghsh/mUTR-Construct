...
2) Run one scenario by SLURM_ARRAY_TASK_ID:
   python generate_compare_control_real_hybrid_struct_pareto_smart5utr.py \
     --mode run_scenario \
     --scenario_set full \
     --generator_model hybrid_struct_besthp_training/hybrid_struct_besthp_final.pt \
...
def parse_args():
    ...
    p.add_argument("--generator_model", default="hybrid_struct_besthp_training/hybrid_struct_besthp_final.pt")
